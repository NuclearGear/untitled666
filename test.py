...
res = requests.get(url="http://member.transrush.com/Member/parcelDetail.aspx?fromTab=dqs&orderNo=DD181211838873",headers=headers).text
...
for i in detail_html.xpath("//dl[@class='detail']/dd/table/tr"):
    print(detail_html.xpath("//dl[@class='detail']/dd/table/tr[2]/td[3]/@title")[0])
    if i.attrib != "":
